...
>(({ className, children, showClose = true, ...props }, ref) => (
  <DialogPortal>
    ...
    >
      {children}
      {showClose && (
        <DialogPrimitive.Close className="absolute right-4 top-4 rounded-lg opacity-70 hover:opacity-100 focus:outline-none focus:ring-2 focus:ring-terracotta">
          <X className="h-5 w-5" />
